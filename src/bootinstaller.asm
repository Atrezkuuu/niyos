...
start:
    ...
    mov bp, installboot_install_message             
    mov cx, 19
    mov bl, 0Fh
    mov ax, 1301h
    int 10h
    ...
    mov bp, niyosfs_install_message             
    mov cx, 19
    mov bl, 0Fh
    mov ax, 1301h
    int 10h
...
installboot_install_message db 'Install installboot...', 0
niyosfs_install_message db 'Install niyosfs...', 0
